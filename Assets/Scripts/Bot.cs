...
public class Bot : MonoBehaviour
{
    ...
    public void Pursue()
    {
        ...
        Seek(target.transform.position + target.transform.forward * lookAhead * 10f);
    }
    ...
    public bool CanSeeTarget()
    {
        ...
        Vector3 targetXZPos = new Vector3(target.transform.position.x, target.transform.position.y, target.transform.position.z);
        Vector3 thisXZPos = new Vector3(transform.position.x, transform.position.x, transform.position.z);
